...
\pdfbookmark[1]{Abstract - English version}{Abstract - English version} % Bookmark name visible in a PDF viewer
...
\graffito{ROS is a open-source component based software framework, where components are usually written and released by third party developers for being easily reused, avoiding the necessity of "re-inventing the wheel".}
